...
abstract class AbstractAlgorithmsTests {
    ...
    fun longestCommonSubstring(longestCommonSubstring: (String, String) -> String) {
        assertEquals("", longestCommonSubstring("Привет", ""))
        assertEquals("ет", longestCommonSubstring("Привет", "Пакеты"))
        assertEquals("мой, я", longestCommonSubstring("мой, я", "мой, мой, я"))
